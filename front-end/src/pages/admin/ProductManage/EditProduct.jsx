            ...
            <form onSubmit={handleSubmit(onSubmit)} className="row">
              ...
              <div className="form-group col-md-3">
                ...
                {preview ? (
                  ...
                  <img src={preview ? preview : {...register('file')}} style={{width: 200, height: 220, marginTop:10}} /> <button onClick={() => setPreview(null)} className="btn btn-primary btn-sm trash preview">xóa</button>
                </div>
                ): (
                  <div id="boxchoice">
