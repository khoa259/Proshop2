        ...
        <div>
            <div>
                ...
                <aside className="app-sidebar">
                    <div className="app-sidebar__user"><img style={{ marginLeft: "70px" }} className="app-sidebar__user-avatar" src="https://picsum.photos/200" width="50px" alt="User Image" />
                        <div>
                            <p className="app-sidebar__user-name"><b>Nhóm 1</b></p>
                            <p className="app-sidebar__user-designation">Chào mừng bạn trở lại</p>
                        </div>
                    </div>
                    <hr />
                    <ul className="app-menu">
                        <Link to=""><li><a className="app-menu__item active" href="index.html"><i className="app-menu__icon bx bx-tachometer" /><span className="app-menu__label">Bảng điều khiển</span></a></li></Link>
                        ...
                        <Link to='product'><li><a className="app-menu__item" href="table-data-product.html"><i className="app-menu__icon bx bx-purchase-tag-alt" /><span className="app-menu__label">Quản lý sản phẩm</span></a>
                        </li></Link>
